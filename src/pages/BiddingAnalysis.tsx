        ...
        <Card style={{ maxWidth: 800, margin: '0 auto' }}>
          <div style={{ textAlign: 'center' }}>
            ...
            <FileUpload 
              ...
              hintText="支持 PDF、DOCX、TXT、XLSX 格式，最大50MB"
            />
            
            <div style={{ marginTop: 16, padding: 12, background: '#fff7e6', borderRadius: 8, border: '1px solid #ffe58f' }}>
              <Text type="warning">
                ⚠️ 注意：不支持旧版 <strong>.doc</strong> 和 <strong>.xls</strong> 格式。请在Word/Excel中打开文件后，选择"另存为"并保存为 <strong>.docx</strong> 或 <strong>.xlsx</strong> 格式后再上传。
              </Text>
            </div>
